...
public partial class BoidSystemECSJobs : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        JobHandle boidJobHandle = boidJob.Schedule(Dependency);
        
           boidMoveJob.Schedule(boidJobHandle);
    }
    ...
    private partial struct BoidJob : IJobEntity
    {
        ...
        [ReadOnly] public int boidIndex;

        public void Execute(Entity boid, [ReadOnly] ref LocalToWorld localToWorld)
        {
    ...
    private partial struct BoidMoveJob : IJobEntity
    {
        ...
        public void Execute(Entity boid, [WriteOnly] ref LocalToWorld localToWorld)
        {
